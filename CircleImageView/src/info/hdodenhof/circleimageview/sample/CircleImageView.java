package info.hdodenhof.circleimageview.sample;
...
public class CircleImageView extends ImageView {
	...
	public void setCircleBackgroundColor(@ColorRes int circleBackgroundColor) {
	...
	public void setCircleBackgroundColorResource(
			@ColorRes int circleBackgroundRes) {
		setCircleBackgroundColor(getContext().getResources().getColor(
				circleBackgroundRes));
	}
	...
	private boolean inTouchableArea(float x, float y) {
		return Math.pow(x - mBorderRect.centerX(), 2)
				+ Math.pow(y - mBorderRect.centerY(), 2) <= Math.pow(
				mBorderRadius, 2);
	}
